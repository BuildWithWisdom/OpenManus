...
export const MODEL_GROUPS: ModelGroup[] = [
  {
    ...
    models: [
      { id: 'z-ai/glm-5.2', name: 'GLM 5.2', provider: 'NVIDIA NIM', providerSlug: 'custom-nvidia' },
      ...
      { id: 'deepseek-ai/deepseek-v4-pro', name: 'DeepSeek V4 Pro', provider: 'NVIDIA NIM', providerSlug: 'custom-nvidia' },
      { id: 'deepseek-ai/deepseek-v4-flash', name: 'DeepSeek V4 Flash', provider: 'NVIDIA NIM', providerSlug: 'custom-nvidia' },
      { id: 'deepseek-ai/deepseek-coder-6.7b-instruct', name: 'DeepSeek Coder 6.7B', provider: 'NVIDIA NIM', providerSlug: 'custom-nvidia' },
      { id: 'thinkingmachines/inkling', name: 'Inkling Reasoning', provider: 'NVIDIA NIM', providerSlug: 'custom-nvidia' },
      { id: 'nvidia/cosmos-reason2-8b', name: 'Cosmos Reason 2 8B', provider: 'NVIDIA NIM', providerSlug: 'custom-nvidia' },
      { id: 'moonshotai/kimi-k2.6', name: 'Kimi K2.6', provider: 'NVIDIA NIM', providerSlug: 'custom-nvidia' },
